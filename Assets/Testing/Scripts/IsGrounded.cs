...
namespace Testing.Scripts
{
    public class IsGrounded : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            RaycastHit2D hitLeft = Physics2D.Raycast(posLeft, Vector2.down, depth, LayerMask.GetMask("Background"));
            RaycastHit2D hitRight = Physics2D.Raycast(posRight, Vector2.down, depth, LayerMask.GetMask("Background"));
